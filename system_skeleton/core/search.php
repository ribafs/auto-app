...
<?php
print '<div class="text-center"><h4><b>Register(s) found(s)</b>: '.count($rows).' with <b>'.$keyword.'</b></h4></div>';
...
<div class="text-center"><input name="send" class="btn btn-warning" type="button" onclick="location='index.php?table=<?=$table?>'" value="Back"></div>
</div>
<br>
