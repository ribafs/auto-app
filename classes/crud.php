    ...
    public function fetchData($start){
        ...
        if($numberRegs > 0){
            while($row = $results->fetch(PDO::FETCH_ASSOC)) {
                ...
                print "<td><a href=\"update.php?id=".$row['id']."&table=".$this->table."\"><i class=\"glyphicon glyphicon-edit\" title=\"Editar\"></a></td><td><a onclick=\"return confirm('Tem certeza de que deseja excluir $id ?')\" href=\"delete.php?id=$id&table=".$this->table."\"><i class=\"glyphicon glyphicon-remove-circle\" title=\"Excluir\"></a></td></tr>";
            }
        }else{
